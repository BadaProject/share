...
class PLCPacket:
	def __init__(self):
		...
		0x00, 0x00, # Reserved[2]
		0x0C, 0x01, # PLC Info[2]
		0xB0, # CPU Info[1]
		0x33, # Source of Frame[1]
		0x00, 0x00, # Invoke ID[2]
		0x14, 0x00, # Length[2]
		0x01, # Bit0~3 : slot # of FEnet I/F module, Bit4~7 : base # of FEnet I/F module
		...
		0x01, 0x00, # block length[2]
		0x08, 0x00, # block name length[2]
		0x25, 0x44, 0x42, 0x30, 0x30, 0x38, 0x30, 0x30, #  D00401을 읽으려면 %DB00802 를 사용해야 한다.
		0x1E, 0x00 # PLC -> PX4 data size : 30을 16진수로 표현하면 1E이다.
		]
